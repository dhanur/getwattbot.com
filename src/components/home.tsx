  ...
  return (
    ...
    >
      ...
      <div className="px-4 md:px-8 lg:px-16 py-16 md:py-32 bg-[#262626]">
        <div className="max-w-[912px] mx-auto space-y-24 md:space-y-[219px]">
          {/* Installer CTA */}
          <div className="space-y-7 text-center">
            ...
            <h3 className="text-white text-[24px] md:text-[35.09px] font-normal font-lexend leading-[1.4] md:leading-[46.78px] tracking-[0.03em] px-4 md:px-0">
